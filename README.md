...
## Key features
You select a course, chapter, and topic from the Senderos Curriculum. It quizzes you multiple times until you consistently get it right. There is a streak counter as well as "I got it right/wrong" buttons in case the system made a mistake.

## Keyboard shortcuts
There are multiple keyboard shorcuts installed to make it easy to operate the site. However, they do not work on Safari.
